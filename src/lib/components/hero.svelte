<div class="max-w-3xl my-4">
	<h2 class="text-base/7 font-semibold text-secondary">Jay Smith</h2>
	<h1 class="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
		legal engineer, developer and founder
	</h1>
	<p class="mt-6 text-base text-zinc-600 dark:text-zinc-400">
		I’m, Jay, the Fresh Prince of LegalTech. I am a legal engineer, developer, and founder passionate about creating
		...
		more effective services that empower both clients and teams.
	</p>
	<div class="mt-6 flex gap-6">
		<!-- <a class="group -m-1 p-1" aria-label="Follow on X" href=""
			><svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 fill-secondary transition group-hover:fill-accent"
				><path
			...
			></a
		> -->
		<a class="group -m-1 p-1" aria-label="Follow on GitHub" href="https://github.com/thisisthejay" target="_blank"
			><svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 fill-secondary transition group-hover:fill-accent"
				><path
					fill-rule="evenodd"
					clip-rule="evenodd"
		...
		><a
			...
			href="https://www.linkedin.com/in/jermainepaulsmith/"
			target="_blank"
			><svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 fill-secondary transition group-hover:fill-accent"
				><path
